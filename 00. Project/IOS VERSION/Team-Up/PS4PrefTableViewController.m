...
#import "PS4PrefTableViewController.h"
#import <Parse/Parse.h>
#import "AppDelegate.h"

@interface PS4PrefTableViewController ()

@end

@implementation PS4PrefTableViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey:@"parentCatogery" equalTo:[PFObject objectWithoutDataWithClassName:@"Catogery" objectId:@"G0CoJ5nefN"]];

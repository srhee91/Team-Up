...
#import "WiiUPrefTableViewController.h"
#import <Parse/Parse.h>
#import "AppDelegate.h"

@interface WiiUPrefTableViewController ()

@end

@implementation WiiUPrefTableViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey:@"parentCatogery" equalTo:[PFObject objectWithoutDataWithClassName:@"Catogery" objectId:@"bbl20C4iTf"]];

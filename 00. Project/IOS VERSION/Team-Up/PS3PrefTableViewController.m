...
#import "PS3PrefTableViewController.h"
#import <Parse/Parse.h>
#import "AppDelegate.h"

@interface PS3PrefTableViewController ()

@end

@implementation PS3PrefTableViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey:@"parentCatogery" equalTo:[PFObject objectWithoutDataWithClassName:@"Catogery" objectId:@"OgXg1yBuGf"]];
